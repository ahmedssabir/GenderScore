...
woman_twitter_context ='This tweet was written by woman'
man = cloze_prob(man_twitter_context)
woman= cloze_prob(woman_twitter_context)

print(man_twitter_context, man)
print(woman_twitter_context,woman)
